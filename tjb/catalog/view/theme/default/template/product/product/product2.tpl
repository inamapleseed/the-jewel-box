	...
	<div id="content" class="<?= $class; ?>">
		...
		<div class="row">
			...
			<?php } else { ?>
				<?php $class = 'col-sm-6'; ?>
			<?php } ?>
			<div class="<?= $class; ?> col-lg-6 pd-lg-r60" data-aos="fade-left">
			...
			<div class="<?= $class; ?> col-lg-6" data-aos="fade-up">
				<?php include_once('product_description2.tpl'); ?>
  ...
  // product option change image gallery
  	...
  	function initSlick() {
	  	...
	  	$('.product-image-main').slick({
	  		...
	  		prevArrow: "<div class='pointer slick-nav left prev'><div class='absolute position-center-center'><img src='image/catalog/slicing/general/prev.png' alt='up-arrow'/></div></div>",
	  		nextArrow: "<div class='pointer slick-nav right next'><div class='absolute position-center-center'><img src='image/catalog/slicing/general/next.png' alt='down-arrow'/></div></div>",
	  	});
      	...
      	setTimeout(function(){ 
		  	<?php if ($vertical_slider) { ?>
		  		$('.product-image-additional').slick({
		  			...
		  			infinite: true,
		  			vertical: true,
		  			prevArrow: "<div class='pointer slick-nav left prev'><div class='absolute position-center-center'><img src='image/catalog/slicing/general/up.png' alt='up-arrow'/></div></div>",
		  			nextArrow: "<div class='pointer slick-nav right next'><div class='absolute position-center-center'><img src='image/catalog/slicing/general/down.png' alt='down-arrow'/></div></div>",
		  		});
		  	<?php } else { ?>
