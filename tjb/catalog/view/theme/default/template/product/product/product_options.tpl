...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <div class="btns">
        ...
        <?php } ?>
          <button type="button" id="button-enquiry" onclick="enquiry.add('<?= $product_id; ?>', '<?= $minimum; ?>')" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><?= $button_enquiry; ?></button>
      </div>
