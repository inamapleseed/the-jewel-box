...
class ControllerProductCategory extends Controller {
	...
	public function index() {
        ...
        $this->session->data['main_product'] = "masterpiece";
		...
		$data['breadcrumbs'][] = array(
			'text' => $data['heading_title_master'],
			//'href' => $this->url->link('product/category') . $breadcrumbs_filter
			'href' => $this->url->link('product/masterpiece')
		);
			...
			foreach($categories as $category_id){
				...
				if($category_info){
					...
					$data['breadcrumbs'][] = array(
						...
						'href' => $this->url->link('product/masterpiece', 'path=' . implode('_', $category_path) . $breadcrumbs_filter)
					);
				}
		...
		foreach ($results as $result) {
			$data['products'][] = $this->load->controller('component/product_info2', array( 'product_id' => $result['product_id'], 'url' => $after_clean));
		}
