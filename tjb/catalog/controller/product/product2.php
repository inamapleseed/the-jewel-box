...
class ControllerProductProduct2 extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('product/product2', $url . '&product_id=' . $this->request->get['product_id'])
			);

			$this->document->setTitle($product_info['meta_title']);
			$this->document->setDescription($product_info['meta_description']);
			$this->document->setKeywords($product_info['meta_keyword']);
			$this->document->addLink($this->url->link('product/product2', 'product_id=' . $this->request->get['product_id']), 'canonical');
			...
			if ($this->config->get('config_review_guest') || $this->customer->isLogged()) {
				...
				$this->session->data['redirect'] = $this->url->link('product/product2', $url . '&product_id=' . $this->request->get['product_id']);
			}
			...
			if($data['download']){
				$data['download'] = $this->url->link('product/product2/download', 'document_id='.$data['download']);
			}

			$data['share'] = $this->url->link('product/product2', 'product_id=' . (int)$this->request->get['product_id']);
			...
			$this->response->setOutput($this->load->view('product/product/product2', $data));
		} else {
			$url = '';
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('product/product2', $url . '&product_id=' . $product_id)
			);
	...
	public function review() {
		...
		$pagination->limit = 5;
		$pagination->url = $this->url->link('product/product2/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
	...
	public function download(){
		...
		if ($download_info) {
			...
			$this->response->redirect($this->url->link('product/product2', '', true));
		}
	}
	// << OPTIONS IMAGE
