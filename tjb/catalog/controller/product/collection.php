...
class ControllerProductCollection extends Controller {
	...
	public function index() {
        ...
        $this->session->data['main_product'] = "collection";
		...
		$data['breadcrumbs'][] = array(
			'text' => $data['heading_title_collect'],
			...
			foreach($categories as $category_id){
				...
				if($category_info){
					...
					$data['breadcrumbs'][] = array(
						...
						'href' => $this->url->link('product/collection', 'path=' . implode('_', $category_path) . $breadcrumbs_filter)
					);
				}
		...
		$page_data = array(
			...
			'page'	=>	$page,
			'limit'	=>	$limit,
			'url'	=>	$this->url->link('product/collection', $path . 'page={page}'. $pagination_filter),
		); 
