...
class ControllerAccountAddress extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
				...
				'unit_no'	=> $result['unit_no']?$result['unit_no'].',':'',
				'city'      => $result['city'],
	...
	protected function getForm() {
		...
		if (isset($this->error['unit_no'])) {
			$data['error_unit_no'] = $this->error['unit_no'];
		} else {
			$data['error_unit_no'] = '';
		}
		...
		if (isset($this->request->post['unit_no'])) {
			$data['unit_no'] = $this->request->post['unit_no'];
		} elseif (!empty($address_info)) {
			$data['unit_no'] = $address_info['unit_no'];
		} else {
			$data['unit_no'] = '';
		}
