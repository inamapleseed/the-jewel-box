...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		if(isset($this->request->get['route']) && ($this->request->get['route'] == 'checkout/cart' || $this->request->get['route'] == 'checkout/checkout' || $this->request->get['route'] == 'quickcheckout/checkout') ) {
			$data['show_cart'] = 1;
		}
		// show cart url instead of toggle cart
