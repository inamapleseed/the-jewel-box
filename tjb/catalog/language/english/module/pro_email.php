...
$_['text_voucher_greeting'] = 'Congratulations, You have received a Gift Card worth <b>{amount}</b>';
$_['text_voucher_from'] = 'This Gift Card has been sent to you by <b>{from}</b>';
$_['text_voucher_message'] = 'With a message saying:<br/>{message}';
$_['text_voucher_code'] = '<b>Redemption code:</b> <b>{code}</b>';
$_['text_voucher_redeem'] = 'To redeem this Gift Card, write down the redemption code then click on the the link below and purchase the product you wish to use this gift voucher on. You can enter the gift voucher code on the shopping cart page before you click checkout.';
...
$_['text_enquiry_detail'] = 'Enquiry Details';
...
$_['text_stock_welcome']        	= 'Good day!';
$_['text_stock_message']        	= 'Below are the inventory count updates: ';
?>