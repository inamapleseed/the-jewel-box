      ...
      <div class="panel-body">
        ...
        <div class="tab-content">  
         <div class="tab-pane active" id="tab-general">
          ...
          <div id="presize" class="form-group hidden">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left" style="min-width:120px;"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?>
                  <?php } ?></td>
                <td class="text-left" style="width: 30%;min-width:80px;"><textarea rows="5" name="gallimage_image[<?php echo $image_row; ?>][link]" placeholder="Description" class="form-control"><?php echo $gallimage_image['link']; ?></textarea></td>
                ...
                <td class="text-right hidden" style="width: 10%;min-width:60px;"><input type="text" name="gallimage_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $gallimage_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
  ...
  <script type="text/javascript">
      ...
      $('input[name=\'category\']').autocomplete({
        'source': function(request, response) {
          $.ajax({
            url: 'index.php?route=catalog/gallery_category/autocomplete&token=<?= $token; ?>&filter_name=' +  encodeURIComponent(request),
            dataType: 'json',
...
function addImage() {
	...
	<?php } ?>
	html += '  </td>';	
	html += '  <td class="text-left" style="width: 30%;min-width:80px;"><textarea name="gallimage_image[' + image_row + '][link]"  placeholder="<?php echo $entry_link; ?>" class="form-control"></textarea></td>';	
	...
	html += '  <td class="text-right hidden" style="width: 10%;min-width:60px;"><input type="text" name="gallimage_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
