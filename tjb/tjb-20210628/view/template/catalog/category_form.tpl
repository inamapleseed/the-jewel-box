	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="button" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary btn-submit" onclick="$('#form-category').submit();"><i class="fa fa-save"></i></button>
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
					...
					<div class="tab-content">
								...
								<?php foreach ($languages as $language) { ?>
									<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<textarea name="category_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="<?php if ($ckeditor_enabled == 1) { ?>form-control<?php } else { ?>form-control summernote<?php } ?>"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['description'] : ''; ?></textarea>
											</div>
										</div>
										<div class="form-group required">
						...
						<div class="tab-pane " id="tab-data">
							...
							<!-- Start products or gallery -->
								<div class="form-group required">
									...
									<div class="col-sm-10">
										...
										<div class="radio">
											<label>
												<input type="radio" name="category_names" value="masterpiece" 
												<?php if($category_names == 'masterpiece'){?>
													checked="checked"<?php } ?>
													 />
												Masterpiece
											</label>
										...
										<div class="radio">
											<label>
												<input type="radio" name="category_names" value="readytowear" 
												<?php if($category_names == 'readytowear'){?>
													checked="checked"<?php } ?>
													 />
												Ready To Wear
											</label>
										...
										<div class="radio">
											<label>
												<input type="radio" name="category_names" value="collection" 
												<?php if($category_names == 'collection'){?>
													checked="checked"<?php } ?>
													 />
												Collection
											</label>
										...
										<?php if ($error_category_names) { ?>
											<div class="text-danger"><?php echo $error_category_names; ?></div>
										<?php } ?>
									</div>
								</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-admin-use"><span data-toggle="tooltip" title="<?php echo $help_admin_use; ?>"><?php echo $entry_admin_use; ?></span></label>
								<div class="col-sm-10">
									<div class="checkbox">
										<label>
											<?php if ($backend_only) { ?>
												<input type="checkbox" name="backend_only" value="1" checked="checked" id="input-admin-use" />
												<?php } else { ?>
												<input type="checkbox" name="backend_only" value="1" id="input-admin-use" />
											<?php } ?>
										&nbsp; </label>
									</div>
								</div>
