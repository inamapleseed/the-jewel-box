						...
						<div class="tab-pane" id="tab-links">
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										...
										<div class="radio">
											<label>
												<input type="radio" name="products_category" value="masterpiece" <?php if($products_category == 'masterpiece'){?>checked="checked"<?php } ?> />
												Masterpiece
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="products_category" value="readytowear" <?php if($products_category == 'readytowear'){?>checked="checked"<?php } ?> />
												Ready to wear
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="products_category" value="collection" <?php if($products_category == 'collection'){?>checked="checked"<?php } ?> />
												Collection
											</label>
										</div>
			
										<?php if ($error_products_category) { ?>
											<div class="text-danger"><?php echo $error_products_category; ?></div>
										<?php } ?>
									</div>
								</div>
