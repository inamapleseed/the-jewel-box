              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td width="30px" class="text-right"><?php echo $entry_sort_order; ?></td>
                    <td width="1px"></td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left">
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" placeholder="Text Position" class="form-control" />
                      ...
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title_text]" value="<?php echo $banner_image['title_text']; ?>" placeholder="Title Here" class="form-control" />

                      <label style="margin-top: 15px">Title Max Font Size</label>
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title_font_size]" value="<?php echo $banner_image['title_font_size']; ?>" placeholder="Title Max Font Size" class="form-control" />

                      <label style="margin-top: 15px">Button Position</label>
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][btn_pos]" value="<?php echo $banner_image['btn_pos']; ?>" placeholder="Button Position" class="form-control" />

                   <!--    <label style="margin-top: 15px">Google Font Link</label>
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][google_link]" value="<?php echo $banner_image['google_link']; ?>" placeholder="Google Font Link" class="form-control" />

                      <label style="margin-top: 15px">Google Font Family</label>
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][google_font]" value="<?php echo $banner_image['google_font']; ?>" placeholder="Google Font Family" class="form-control" />
 -->
                    <span class="extras">
                      <hr/>
                      <p>Description</p>  
...
<!--                     <td class="text-center">
                      <a href="" id="thumb-video-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">
                      <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][video]" value="<?= $banner_image['video'] ?>" id="input-video-<?php echo $image_row; ?>" class="form-control" /><span class="upload-btn">upload</span></a>

                      <label style="margin-top: 15px">YouTube Iframe</label>
                      <input type="text" placeholder="YouTube Iframe" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][youtube]" value="<?= $banner_image['youtube'] ?>" id="input-youtube-<?php echo $image_row; ?>" class="form-control" />
                    </td> -->
...
function addImage(language_id) {
  ...
  html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="Text Position" class="form-control" /><label style="margin-top: 15px">Title</label><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title_text]" value="" placeholder="Title Here" class="form-control" /><br><label style="margin-top: 15px">Title Max Font Size</label><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title_font_size]" value="" placeholder="Title Max Font Size" class="form-control" /><br><label style="margin-top: 15px">Button Position</label><input type="text" name="banner_image[' + language_id + '][' + image_row + '][btn_pos]" value="" placeholder="Button Position" class="form-control" /><br><span class="extras"><hr/><p>Description</p><textarea rows="3" class="form-control" name="banner_image[' + language_id + ']['+ image_row +'][description]" ></textarea></span>';
  html += '  <span class="extras"><p>Label</p><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link_text]" value="" placeholder="Label" class="form-control" /><p>Link</p></span><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" />'; 
