    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-date_of_purchase">Date of Purchase</label>
            <div class="col-sm-10">
              <input type="text" name="date_of_purchase" value="<?php echo $date_of_purchase; ?>" placeholder="Date of Purchase" id="input-date_of_purchase" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
