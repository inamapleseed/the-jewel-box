            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="View / Update Order Status" class="btn btn-info"><i class="fa fa-eye"></i></a> <a href="<?php echo $order['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
  ...
  $('#button-pickpacklist, #button-shipping, #button-invoice').prop('disabled', true);
    ...
    $('#button-invoice').prop('disabled', false);
		if ($(selected[i]).parent().find('input[name^=\'shipping_code\']').val()) {
			$('#button-pickpacklist, #button-shipping').prop('disabled', false);
