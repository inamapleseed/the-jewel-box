...
class ControllerTestimonialTestimonial extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->error['date_of_purchase'])) {
			$data['error_date_of_purchase'] = $this->error['date_of_purchase'];
		} else {
			$data['error_date_of_purchase'] = '';
		}
		...
		if (isset($this->request->post['date_of_purchase'])) {
			$data['date_of_purchase'] = $this->request->post['date_of_purchase'];
		} elseif (!empty($review_info)) {
			$data['date_of_purchase'] = $review_info['date_of_purchase'];
		} else {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['title']) < 4) || (utf8_strlen($this->request->post['title']) > 64)) {
			$this->error['title'] = $this->language->get('error_title');
		}

		if (utf8_strlen($this->request->post['text']) < 8) {
