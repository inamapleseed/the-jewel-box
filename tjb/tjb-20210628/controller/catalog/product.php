...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['products_category'])) {
			$data['products_category'] = $this->request->post['products_category'];
		} elseif (!empty($product_info)) {
			$data['products_category'] = $product_info['products_category'];
		} else {
		...
		// Start products or gallery
		if (isset($this->error['products_category'])) {
				$data['error_products_category'] = $this->error['products_category'];
			}
			else {
				$data['error_products_category'] = '';
			}
		// End products or gallery
	...
	protected function validateForm() {
		...
		// Start products or gallery
		if (!isset($this->request->post['products_category'])) {
				$this->error['products_category'] = $this->language->get('error_products_category');
			}
		// End products or gallery
