...
class ControllerCatalogGallimage extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_category'])) {
			...
			$categories = array();
			$results = $this->model_catalog_gallerycategory->getGallCategories($this->request->get['gallimage_id']);
			foreach ($results as $result) {
		...
		foreach ($categories as $category_id) {
			$category_info = $this->model_catalog_gallerycategory->getGallCategory($category_id);
			if ($category_info) {
				$data['product_categories'][] = array(
					'category_id' => $category_info['gall_cat_id'],
