<?php
// Hackes
define('URL', $_SERVER['HTTP_HOST'] . str_replace('/tjb-20210628', '', dirname($_SERVER['PHP_SELF']))."/");
define('BASE_DIR', str_replace(DIRECTORY_SEPARATOR,"/",str_replace(DIRECTORY_SEPARATOR . "tjb-20210628", "", realpath(dirname(__FILE__))))."/");
// Dynamic Protocol Settings
$protocol = "http://";
if($_SERVER["SERVER_PORT"] == 443){	$protocol = "https://";}
// HTTP Protocol
define('HTTP_SERVER', $protocol . URL. 'tjb-20210628/');
define('HTTPS_SERVER', $protocol . URL. 'tjb-20210628/');
...
// Directory
define('DIR_APPLICATION', BASE_DIR. 'tjb-20210628/');
define('DIR_SYSTEM', BASE_DIR. 'system/');
define('DIR_IMAGE', BASE_DIR. 'image/');
define('DIR_LANGUAGE', BASE_DIR. 'tjb-20210628/language/');
define('DIR_TEMPLATE', BASE_DIR. 'tjb-20210628/view/template/');
...
define('DB_USERNAME', 'thejewel_db');
define('DB_PASSWORD', '}K_W$Xqndo&5');
define('DB_DATABASE', 'thejewel_db');
define('DB_PORT', '3306');
define('DB_PREFIX', 'thejewelbox_');

define('BANNER_EXTRA', true);
define('ADVANCE_PASSWORD', false);
define('ADMIN_FOLDER', 'tjb-20210628');
